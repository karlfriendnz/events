...
export const DISCOUNT_TEMPLATES = [
  { label: 'Weekly package', description: 'Book 5+ sessions, 20% off per session', icon: 'pi-calendar-clock',
  ...
  { label: 'Sibling discount', description: 'Register 2+ people, cheapest gets 10% off', icon: 'pi-users',
  ...
  { label: 'Family deal', description: 'Register 3+ people, cheapest gets 25% off', icon: 'pi-heart',
  ...
  { label: 'Promo code', description: 'Registrant enters a code at checkout', icon: 'pi-ticket',
  ...
  { label: 'Age-based', description: 'Auto-applies for a specific age range', icon: 'pi-user',
  ...
  { label: 'First 50 registrations', description: 'Discount for the first 50 people to register', icon: 'pi-bolt',
