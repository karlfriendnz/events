...
export const invitees = mysqlTable('invitees', {
  ...
  updatedAt: timestamp('updated_at').notNull().defaultNow(),
  attended: boolean('attended').notNull(),
  signedOut: boolean('signed_out').notNull(),
...
export const organisations = mysqlTable('organisations', {
  ...
  createdAt: timestamp('created_at').notNull().defaultNow(),
  updatedAt: timestamp('updated_at').notNull().defaultNow(),
  defaultPaymentOptions: json('default_payment_options').notNull(),
  defaultFormId: varchar('default_form_id', { length: 36 }),
  defaultPaymentMethod: text('default_payment_method'),
  defaultBankAccountId: varchar('default_bank_account_id', { length: 36 }),
  eventsDefaultPaymentOptions: json('events_default_payment_options').notNull(),
  ...
  bookerTheme: json('booker_theme').notNull(),
  ...
  terminology: json('terminology').notNull(),
  defaultSportName: text('default_sport_name'),
  clubTypeIds: json('club_type_ids').notNull(),
  ...
  coreFields: json('core_fields').notNull(),
  defaultMemberPositions: json('default_member_positions').notNull(),
